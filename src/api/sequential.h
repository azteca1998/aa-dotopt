...
PyObject *api_dot_sequential_omp_loops_impl(PyObject *self, PyObject *args);
PyObject *api_dot_sequential_omp_loops_zorder_impl(
    PyObject *self,
    PyObject *args
);
...
const static struct PyMethodDef api_dot_sequential_omp_loops = {
    .ml_name = "dot_sequential_omp_loops",
    .ml_doc = "Sequential matrix multiplication.",
    .ml_flags = METH_VARARGS,
    .ml_meth = &api_dot_sequential_omp_loops_impl,
};

const static struct PyMethodDef api_dot_sequential_omp_loops_zorder = {
    .ml_name = "dot_sequential_omp_loops_zorder",
    .ml_doc = "Sequential matrix multiplication using Z-order curve.",
    .ml_flags = METH_VARARGS,
    .ml_meth = &api_dot_sequential_omp_loops_zorder_impl,
};
